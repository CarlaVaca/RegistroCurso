...
-- Insertar personas
INSERT INTO `curso_registro`.`personas` (`nombre`, `email`, `telefono`) 
VALUES
('Alejandro Silva', 'alejandro.silva@example.com', '3456712345'),
('Beatriz Jiménez', 'beatriz.jimenez@example.com', '4567812345'),
('Camilo Castro', 'camilo.castro@example.com', '5678912345'),
('Diana Paredes', 'diana.paredes@example.com', '6789012345'),
('Eduardo Rojas', 'eduardo.rojas@example.com', '7890123456'),
('Gabriela Peña', 'gabriela.pena@example.com', '8901234567'),
('Hugo García', 'hugo.garcia@example.com', '9012345678'),
('Irene Ávila', 'irene.avila@example.com', '1123456789'),
('Joaquín Aguilar', 'joaquin.aguilar@example.com', '2234567890'),
('Karina Valle', 'karina.valle@example.com', '3345678901'),
('Leonardo Vega', 'leonardo.vega@example.com', '4456789012'),
('Marina Salinas', 'marina.salinas@example.com', '5567890123'),
('Nicolás Estrada', 'nicolas.estrada@example.com', '6678901234'),
('Olivia Fuentes', 'olivia.fuentes@example.com', '7789012345'),
('Pablo Maldonado', 'pablo.maldonado@example.com', '8890123456'),
('Renata Carrillo', 'renata.carrillo@example.com', '9901234567'),
('Samuel Espinoza', 'samuel.espinoza@example.com', '1234509876'),
('Tatiana León', 'tatiana.leon@example.com', '2345610987'),
('Ulises Montes', 'ulises.montes@example.com', '3456712345'),
('Valeria Cárdenas', 'valeria.cardenas@example.com', '4567812345');
